...
class StockEnv(gym.Env):
    ...
    def _take_action(self, action):
        ...
        self.date_list.append(pd.read_csv("./data/" + self.stock_list[self.ran] + ".csv", index_col=0).iloc[self.current_step, 0])
        ...
        if step == self.train_size - 1:
            ...
            table_trace1 = go.Table(
                ...
                header=dict(height=50,
                            values=[['<b>Stard date </b>'], ['<b>Profit rate</b>'], ['<b>Benchmark</b>'],
                                    ['<b>Extra profit rate</b>'], ['<b>Tax fee</b>']],
            ...
            layout = go.Layout(
                title="PPO" + "   Inicial financial asset：" + str(self.INITIAL_ACCOUNT_BALANCE)
                      + "  Benchmark:" + self.stock_choose,
            ...
            print(self.stock_choose,
                  ...
                  round(abs(max_drawdown(self.price_rate_list)), 4))
        return self.asset_match_list, self.price_match_list, self.percent_list

               #self.sharp_ratio,self.beta,self.max_drawdown
