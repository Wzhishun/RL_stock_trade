...
model = PPO2(MlpPolicy, env, verbose=1, tensorboard_log="./log/",n_steps=1024, seed=seed_num,n_cpu_tf_sess=1)
model.learn(total_timesteps=200000, callback=[checkPointCallback, testCallback])
